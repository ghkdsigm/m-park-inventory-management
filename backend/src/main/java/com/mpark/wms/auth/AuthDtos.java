...
public final class AuthDtos {
    ...
    public record ProfileDto(String id, String username, String email, String displayName,
                             String jobTitle, String managedComplex, String role,
    ...
    public record UserUpsertRequest(String username, String password, String displayName,
                                    String email, String jobTitle, String managedComplex, String role) {}
}
